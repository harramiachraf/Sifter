<?php
include_once dirname(_DIR_) . "/controller/ComController.php";
include_once dirname(_DIR_) . "/controller/paramController.php";
include_once dirname(_DIR_) . "/Model/competences.php";
include_once dirname(_DIR_) . "/Model/Langue.php";
